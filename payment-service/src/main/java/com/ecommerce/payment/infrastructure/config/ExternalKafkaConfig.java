...
public class ExternalKafkaConfig {
    ...
    @Value("${external.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean(name = "externalProducerFactory")
    public ProducerFactory<String, Object> externalProducerFactory() {
    ...
    public KafkaTemplate<String, Object> externalKafkaTemplate() {
